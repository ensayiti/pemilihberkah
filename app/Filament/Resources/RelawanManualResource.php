...
use App\Filament\Resources\RelawanManualResource\Pages;
use App\Filament\Resources\RelawanManualResource\RelationManagers;
use App\Models\NIK;
...
class RelawanManualResource extends Resource
{
    protected static ?string $model = RelawanManual::class;

    protected static ?string $navigationIcon = 'heroicon-s-users';

    protected static ?int $navigationSort = 2;

    protected static ?string $navigationLabel = 'Data Relawan [Form]';

    protected static ?string $navigationGroup = 'Database';

    protected static ?string $modelLabel = "Data Relawan [Form]";
    ...
    {
        return [
            'index' => Pages\ListRelawanManuals::route('/'),
            'create' => Pages\CreateRelawanManual::route('/create'),
            'edit' => Pages\EditRelawanManual::route('/{record}/edit'),
        ];
    }
}
